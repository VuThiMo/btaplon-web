        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tables Template</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">DataTables Template</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <main>
                                    ...
                                    <!-- Quy trình 4 bước -->
                                    <!-- thêm template-->
                                    <a href="?controller=addtemplate" class="btn btn-success"><i class="fas fa-user-plus"></i> Create an Template</a>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                 <th scope="col">ID</th>
                                   ...
                                   <!--- sửa xóa-->
      <td>
        <a href="?controller=xuli_template&method=edit&id=<?php echo $value['id']?>"><button class="btn btn-success">update</button></a>
     <a href="?controller=xuli_template&method=dele&id=<?php echo $value['id']?>"><button class="btn btn-danger"><i class="fas fa-user-times"></i></button></a>
      </td>
<!-- bootstrap --->                                  
